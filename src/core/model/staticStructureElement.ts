...
export abstract class StaticStructureElement extends Element {
    ...
    public uses(destination: SoftwareSystem | Container | Component | Person, description: string, technology?: string, interactionStyle = InteractionStyle.Synchronous): Relationship | null {
